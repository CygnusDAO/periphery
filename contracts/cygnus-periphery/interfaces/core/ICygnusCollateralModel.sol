...
interface ICygnusCollateralModel is ICygnusCollateralControl {
    ...
    /**
     *  @dev Reverts when borrowable passed is not this collateral`s borrowable contract
     *
     *  @param passed The address of the invalid borrowable token.
     *  @param borrowable The address of the valid borrowable token for this collateral.
     *
     *  @custom:error BorrowableInvalid
     */
    error CygnusCollateralModel__BorrowableInvalid(address passed, address borrowable);
