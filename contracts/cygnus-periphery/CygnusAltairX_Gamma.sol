...
/*  ═══════════════════════════════════════════════════════════════════════════════════════════════════════════  
    .               .            .               .      🛰️     .           .                .           .
     ...
     🛰️  .             ░░██████  ░░██████                                             .                 .           
        ...
        CYGNUS ALTAIR EXTENSION - `Gamma Pools`                                                           
    ═══════════════════════════════════════════════════════════════════════════════════════════════════════════  */
...
import { ICygnusNebula } from "./interfaces/core/ICygnusNebula.sol";
...
contract CygnusAltairX is CygnusAltair {
     ...
     */
    constructor(IHangar18 _hangar18, string memory _name, ICygnusNebula _nebula) CygnusAltair(_hangar18) {
        // Name
    ...
    function getTokenWeights(
        ...
        unchecked {
            ...
            // We only use 0, keep this for frontend
    ...
    function altairLiquidate_f2x(
        ...
        flashLiquidatePrivate(
            ...
            repayAmount, // The USD amount repaid (without the liq incentive)
